...
namespace B2Net
{
  public interface IFiles
  {
    ...
    Task<B2File> DownloadById(string fileId, bool useStream = false, CancellationToken cancelToken = default(CancellationToken));
    Task<B2File> DownloadById(string fileId, int startByte, int endByte, bool useStream = false, CancellationToken cancelToken = default(CancellationToken));
    Task<B2File> DownloadByName(string fileName, string bucketName, bool useStream = false, CancellationToken cancelToken = default(CancellationToken));
    ...
    Task<B2File> DownloadByName(string fileName, string bucketName, int startByte, int endByte, bool useStream = false, CancellationToken cancelToken = default(CancellationToken));
	...
	Task<B2File> Upload(Stream fileData, string fileName, B2UploadUrl uploadUrl, string bucketId = "", Dictionary<string, string> fileInfo = null, CancellationToken cancelToken = default(CancellationToken));
	Task<B2File> Upload(Stream fileData, string fileName, B2UploadUrl uploadUrl, bool autoRetry, string bucketId = "", Dictionary<string, string> fileInfo = null, CancellationToken cancelToken = default(CancellationToken));
	}
}